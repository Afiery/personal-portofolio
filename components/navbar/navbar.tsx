  ...
  return (
    <nav className="fixed z-10 top-6 inset-x-4 h-14 bg-background border dark:border-slate-700/70 max-w-screen-md mx-auto rounded-full">
      <div className="h-full flex items-center justify-between mx-auto px-3">
        ...
        <a href="https://github.com/afiery" target="_blank" rel="noopener noreferrer">
          <Button
            variant="outline"
          ...
          >
           ...
           {/* LinkedIn Link */}
           <a href="https://www.linkedin.com/in/fikri-p-2986aa137/" target="_blank" rel="noopener noreferrer">
